...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/JSO.js");
/******/ })
/************************************************************************/
/******/ ({
...
var _ExpiredTokenError = __webpack_require__(/*! ../errors/ExpiredTokenError */ "./src/errors/ExpiredTokenError.js");
...
var _assign = __webpack_require__(/*! core-js/fn/object/assign */ "./node_modules/core-js/fn/object/assign.js");
...
var _BasicLoader = __webpack_require__(/*! ./Loaders/BasicLoader */ "./src/Loaders/BasicLoader.js");

var _BasicLoader2 = _interopRequireDefault(_BasicLoader);

var _HTTPRedirect = __webpack_require__(/*! ./Loaders/HTTPRedirect */ "./src/Loaders/HTTPRedirect.js");

var _HTTPRedirect2 = _interopRequireDefault(_HTTPRedirect);

var _IFramePassive = __webpack_require__(/*! ./Loaders/IFramePassive */ "./src/Loaders/IFramePassive.js");

var _IFramePassive2 = _interopRequireDefault(_IFramePassive);

var _Popup = __webpack_require__(/*! ./Loaders/Popup */ "./src/Loaders/Popup.js");

var _Popup2 = _interopRequireDefault(_Popup);

var _Fetcher = __webpack_require__(/*! ./HTTP/Fetcher */ "./src/HTTP/Fetcher.js");

var _Fetcher2 = _interopRequireDefault(_Fetcher);

var _FetcherJQuery = __webpack_require__(/*! ./HTTP/FetcherJQuery */ "./src/HTTP/FetcherJQuery.js");

var _FetcherJQuery2 = _interopRequireDefault(_FetcherJQuery);

var _OAuthResponseError = __webpack_require__(/*! ./errors/OAuthResponseError */ "./src/errors/OAuthResponseError.js");
...
var _EventEmitter2 = __webpack_require__(/*! ./EventEmitter */ "./src/EventEmitter.js");
...
var JSO = function (_EventEmitter) {
   ...
   */
		...
		value: function getToken(opts) {
			...
			return new Promise(function (resolve, reject) {
				...
				var token = void 0; // = this.store.getToken(this.providerID, scopesRequire)
   ...
   */
     ...
     */
				...
				_utils2.default.log('Skipping window.location.hash');
				...
				_utils2.default.log('Skipping save state [' + request.state + ']');
...
var _BasicLoader2 = __webpack_require__(/*! ./BasicLoader */ "./src/Loaders/BasicLoader.js");
...
var HTTPRedirect = function (_BasicLoader) {
	_inherits(HTTPRedirect, _BasicLoader);

	function HTTPRedirect() {
		_classCallCheck(this, HTTPRedirect);

		return _possibleConstructorReturn(this, (HTTPRedirect.__proto__ || Object.getPrototypeOf(HTTPRedirect)).apply(this, arguments));
	}
...
var _Error2 = __webpack_require__(/*! ./Error */ "./src/errors/Error.js");
...
var OAuthResponseError = function (_Error) {
  _inherits(OAuthResponseError, _Error);

  function OAuthResponseError() {
    _classCallCheck(this, OAuthResponseError);

    return _possibleConstructorReturn(this, (OAuthResponseError.__proto__ || Object.getPrototypeOf(OAuthResponseError)).apply(this, arguments));
  }
...
exports.default = OAuthResponseError;
